  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('sys:file:save')"type="primary" @click="addOrUpdateHandle()">资料上传<i class="el-icon-upload el-icon--right"></i></el-button>
    ...
    >
      ...
      <el-table-column fixed="right" header-align="center" align="center" width="200" label="操作">
        <template slot-scope="scope">
          ...
          <el-button   v-if="isAuth('sys:file:delete')" type="danger"  size="small"  @click="deleteHandle(scope.row.id)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
